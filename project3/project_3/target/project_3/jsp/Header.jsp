...
<style type="text/css">
.Rays {
	background-image: linear-gradient(to bottom right, Brown, Gray,Brown);
...
<body>
	...
	%>
	<div class="header">
		<nav class="navbar navbar-expand-lg fixed-top Rays"> 
		<a
			class="navbar-brand" href="<%=ORSView.WELCOME_CTL%>">
			<img
		...
		<div class="collapse navbar-collapse" id="navbarNav">c
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">  bnm
