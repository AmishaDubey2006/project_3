...
<style>
body {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/bg16.png');
	padding-top: 60px;
}
...
<body>
	...
	<div>
		<form action="<%=ORSView.SUBJECT_LIST_CTL%>" method="post">
			...
			%>
			<center>
				<h1 class="text-dark font-weight-bold pt-3">Subject List</h1>
			</center>
			</br>
			...
			%>
			<center>
				<h1 class="text-primary font-weight-bold pt-3">Subject List</h1>
			</center>
			</br>
