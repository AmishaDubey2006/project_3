...
.am {
	background-image: linear-gradient(to bottom right, Skyblue, Grey,Black );
						...
						<div class="card-body">
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" class="form-control input-group-addon hover"
							...
							<input type="submit" name="operation"
									class="btn-success btn-xl " style="font-size: 17px"
									value="<%=LoginCtl.OP_SIGN_IN%>"> <input type="submit"
									
									name="operation" class="btn-primary btn-md"
									style="font-size: 17px"
									value="<%=UserRegistrationCtl.OP_SIGN_UP%>">

								<%-- <input type="submit" name="operation"
									class="btn btn-outline-success btn-xl " style="font-size: 17px"
									value="<%=LoginCtl.OP_SIGN_IN%>"> <input type="submit"
									name="operation" class="btn btn-outline-primary btn-md"
									style="font-size: 17px"
									value="<%=UserRegistrationCtl.OP_SIGN_UP%>"> --%>
							</div>
							<div class="text-center">
